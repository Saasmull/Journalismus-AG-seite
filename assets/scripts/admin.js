...
function startServerDebug(){
    ...
    var memGraph = new LineGraph(memUsage,100);
    var cpuGraph = new LineGraph(cpuUsage,100);
    var heapGraph = new LineGraph(heapUsage,100);
    var heapSizeGraph = new LineGraph(heapSize,100);
