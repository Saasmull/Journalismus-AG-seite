...
module.exports = class RssFeed{
    ...
    renderItem(article){
        ...
        xml += CONFIG.INDENT + CONFIG.INDENT + "<title>" + encodeURI(utils.rmvEntities(article.metadata.title)) + "</title>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + CONFIG.INDENT + "<link>" + encodeURI(CONFIG.SITE_ROOT + "/article/" + article.path + ".html") + "</link>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + CONFIG.INDENT + "<description>" + encodeURI(utils.rmvEntities(article.metadata.description)) + "</description>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + CONFIG.INDENT + "<media:thumbnail url=\"" + encodeURI(CONFIG.SITE_ROOT + article.metadata.banner) + "\"/>" + CONFIG.BREAK;
    ...
    renderFeed(){
        ...
        xml += CONFIG.INDENT + "<title>" + encodeURI(this.title) + "</title>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + "<link>" + encodeURI(this.link) + "</link>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + "<description>" + encodeURI(this.description) + "</description>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + "<language>de-de</language>" + CONFIG.BREAK;
        xml += CONFIG.INDENT + "<copyright>" + encodeURI(CONFIG.SITE_NAME) + "</copyright>" + CONFIG.BREAK;
