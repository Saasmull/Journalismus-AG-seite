...
function startServerDebug(){
    ...
    var memGraph = new LineGraph(memUsage,75);
    var cpuGraph = new LineGraph(cpuUsage,75);
    var heapGraph = new LineGraph(heapUsage,75);
    var heapSizeGraph = new LineGraph(heapSize,75);
